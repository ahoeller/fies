...
void qapi_free_FaultInfoList(FaultInfoList * obj)
{
    QapiDeallocVisitor *md;
    Visitor *v;
    ...
    md = qapi_dealloc_visitor_new();
    v = qapi_dealloc_get_visitor(md);
    visit_type_FaultInfoList(v, &obj, NULL, NULL);
    qapi_dealloc_visitor_cleanup(md);
}


void qapi_free_FaultInfo(FaultInfo * obj)
{
    QapiDeallocVisitor *md;
    Visitor *v;
    ...
    md = qapi_dealloc_visitor_new();
    v = qapi_dealloc_get_visitor(md);
    visit_type_FaultInfo(v, &obj, NULL, NULL);
    qapi_dealloc_visitor_cleanup(md);
}
