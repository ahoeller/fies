...
void arm_cpu_do_interrupt(CPUState *cs)
{
    ...
    switch (env->exception_index) {
    case EXCP_UDEF:
    	//printf("\nEXCP_UDEF - arm_cpu_do_interrupt\n");
    ...
    case EXCP_SWI:
        ...
        break;
    case EXCP_BKPT:
    	//printf("\nEXCP_BKPT - arm_cpu_do_interrupt\n");
    ...
    case EXCP_PREFETCH_ABORT:
    	//printf("\nEXCP_PREFETCH_ABORT - arm_cpu_do_interrupt\n");
        ...
        break;
    case EXCP_DATA_ABORT:
    	//printf("\nEXCP_DATA_ABORT - arm_cpu_do_interrupt\n");
    ...
    /* High vectors.  */
    if (env->cp15.c1_sys & (1 << 13) || is_safe_rtos) {
    ...
    //printf("\nSWI: %08x;%08x;%08x;%08x;%08x\n",env->regs[15],env->regs[14],env->uncached_cpsr, env->spsr,offset );
}
                              ...
                              int access_type, int mmu_idx)
{
    ...
    //env->uncached_cpsr = env->uncached_cpsr & 0xFFFFFF3F;
    //printf("\n[PAGE FAULT] %08x Accessed host PC: 0x%08x; LR: 0x%08x; CPSR: 0x%08x\n", address, env->regs[15] ,env->regs[14] ,cpsr_read(env));
