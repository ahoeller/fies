...
uint32_t HELPER(fault_controller_call_reg_decoder)(CPUARMState *env, uint32_t regno)
{
    ...
    fault_injection_controller_init(env, &regno64, NULL, FI_REGISTER_ADDR, -1);
    regno = regno64;
...
uint32_t HELPER(fault_controller_call_store_reg)(CPUARMState *env, uint32_t value_to_write, uint32_t regno)
{
	...
	fault_injection_controller_init(env, &regno64, &value_to_write, FI_REGISTER_CONTENT, write_access_type);
...
uint32_t HELPER(fault_controller_call_load_reg)(CPUARMState *env, uint32_t reg_val, uint32_t regno)
{
	...
	fault_injection_controller_init(env, &regno64, &reg_val, FI_REGISTER_CONTENT, read_access_type);
...
//    regno = regno64;
    ...
    //fault_injection_controller_init(env, &regno64, &val, FI_REGISTER_CONTENT, read_access_type);
...
//    uint64_t regno64 = regno;
//    fault_injection_controller_init(env, &regno64, NULL, FI_REGISTER_ADDR, -1);
//    fault_injection_controller_init(env, &regno64, &val, FI_REGISTER_CONTENT, write_access_type);
//    regno = regno64;
